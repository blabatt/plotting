...
\textbf{replot} \textit{ and }\textbf{refresh}\textit{ repeat the last }\textbf{plot}\textit{ command. }\textbf{with}\textit{ phrase sets \say{plot style}-specific characteristics.} \\
...
\entry{40mm}{\dots using 1:5 \textquotesingle \%lf,\%lf,\%lf\textquotesingle}{comma sep}\\
