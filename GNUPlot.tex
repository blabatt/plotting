...
\entry{35mm}{set term pdfcairo font \textquotedbl Times,12\textquotedbl}{set font}\\
...
\entry{35mm}{plot \dots using 1:2:3 lc variable}{data-def\textquotesingle d color}\\
...
\entry{35mm}{plot \dots [lc|lt|fc] <\ul{c}olor\_\ul{s}pec>}{coloring syntax}\\
\entry{35mm}{plot \dots lc 0xFF00FF}{RGB-based CS}\\
\entry{35mm}{plot \dots lc \textquotedbl \#FF00FF\textquotedbl}{\textquotesingle x11\textquotesingle -based CS}\\
\entry{35mm}{plot \dots lc palette frac .2}{fraction $\in$ [0,1]}\\
